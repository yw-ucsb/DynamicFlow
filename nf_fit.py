...
for i in tbar:
    ...
    if (i + 1) % val_interval == 0:
        ...
        if running_val_log_density < best_val_score:
            ...
            torch.save(flow.state_dict(), FILEPATH + 'nf_t{}_bs{}_hd{}_nl{}.t'.format(data_index, batch_size, dim_hidden, num_layers))
...
flow.load_state_dict(torch.load(FILEPATH + 'nf_t{}_bs{}_hd{}_nl{}.t'.format(data_index, batch_size, dim_hidden, num_layers)))
flow.eval()
...
plt.title('nf_t{}_bs{}_hd{}_nl{}.t'.format(data_index, batch_size, dim_hidden, num_layers))
