...
class BaseSlopedPWL(BasePWLX):
    ...
    def forward(self, x):
        ...
        print(skip_deltas.shape)
        biases = self.get_biases().unsqueeze(1) # same as .reshape(-1, 1)
        ...
        print(selected_slopes.shape)
        print(selected_betas.shape)
...
if __name__ == '__main__':
    ...
    f = MonoPWL(num_channels=3, num_breakpoints=2)
